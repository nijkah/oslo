...
class ChunkManager:
    ...
    def __init__(self, chunk_configuration, init_device: Optional[torch.device] = None) -> None:
        ...
        self.device = init_device or torch.cuda.current_device()
    ...
    def register_tensor(self,
        ...
        assert isinstance(tensor, torch.Tensor), "Please feed torch.Tensor to this ChunkManager"
    ...
    def access_chunk(self, chunk: Chunk) -> None:
        ...
        if chunk.device_type == 'cpu':
            chunk.shard_move(torch.cuda.current_device())
