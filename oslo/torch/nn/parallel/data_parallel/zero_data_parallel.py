...
from .data_parallel import _DistributedDataParallel as _DDP
from ._utils import is_ddp_ignored, _cast_float, free_storage
...
class ZeroDDP(_DDP):
    ...
    def _init_chunks(self, param_order, strict_ddp_mode: bool, cpu_offload: bool, pin_memory: bool):
        ...
        for p in param_order.generate():
            ...
            if is_ddp_ignored(p):
                p.data = p.data.to(device=dtype=torch.float16)
                continue
